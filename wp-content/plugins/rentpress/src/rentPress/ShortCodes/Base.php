<?php
/**
 * Topline Shortcode Loader
 * Author:   DJF
 * Company:  30Lines
 * Purpose:  Allows us to register shortcodes within the confines of our beautiful plugin
 */

abstract class rentPress_ShortCodes_Base {
     ...
     * @param  $content shortcode inner contents

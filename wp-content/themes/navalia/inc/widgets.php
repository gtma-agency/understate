    ...
    function understrap_widgets_init() {
        ...
        register_sidebar(
            array(
                ...
                'id'            => 'footerlogo',
                'description'   => __( 'Footer logo', 'understrap' ),
                'before_widget' => '<div id="%1$s" class="footer-logo %2$s dynamic-classes">',
                'after_widget'  => '</div><!-- .footer-logo -->',
            )
        );

        register_sidebar(
            array(
                'name'          => __( 'Footer Content', 'understrap' ),
                'id'            => 'footercontent',
                'description'   => __( 'Footer address, phone number and email', 'understrap' ),
                'before_widget' => '<div id="%1$s" class="footer-content %2$s dynamic-classes">',
                'after_widget'  => '</div><!-- .footer-content -->',
            )
        );

        register_sidebar(
            array(
                'name'          => __( 'Footer Social Media', 'understrap' ),
                'id'            => 'socialmedia',
                'description'   => __( 'Social media icons in footer', 'understrap' ),
                'before_widget' => '<div id="%1$s" class="footer-social-media %2$s dynamic-classes">',
                'after_widget'  => '</div><!-- .footer-social-media -->',
            )
        );
        ...
        register_sidebar(
            array(
                ...
                'id'            => 'footermenu',
                'description'   => __( 'Footer menu', 'understrap' ),
                'before_widget' => '<div id="%1$s" class="footer-menu">',
                'after_widget'  => '</div><!-- .footer-menu -->',
            )
        );
        ...
        register_sidebar(
            array(
                ...
                'id'            => 'footerbottom',
                'description'   => __( 'Footer Bottom', 'understrap' ),
                'before_widget' => '<div id="%1$s" class="footer-bottom">',
                'after_widget'  => '</div><!-- .footer-bottom -->',
            )
        );
    }
